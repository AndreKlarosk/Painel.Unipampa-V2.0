...
const firebaseConfig = {
    ...
    projectId: "painel-unipampa-v1-2",
    storageBucket: "painel-unipampa-v1-2.firebasestorage.app",
...
const USUARIOS_KEY = 'usuariosLocal';
...
function registrarUsuario() {
  ...
  if (usuarios.find(u => u.user === user)) return alert('Usuário já existe');
...
function fazerLogin() {
  ...
  if (match || (user === ADMIN_USER && pass === ADMIN_PASS)) {
    loggedIn = true;
    fecharLogin();
    document.getElementById('admin-panel-page').classList.add('is-active');
    document.getElementById('dashboard-view').classList.remove('is-active');
